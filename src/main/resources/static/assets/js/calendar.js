$(function() {
		...
		$('#datePicker').datepicker({
		    ...
		    startDate: new Date($('#packagePostStart').val() < today ? today : $('#packagePostStart').val() ),	//달력에서 선택 할 수 있는 가장 빠른 날짜. 이전으로는 선택 불가능 ( d : 일 m : 달 y : 년 w : 주)
		    endDate: new Date($('#packagePostEnd').val()),
